...
class Tournament:
    ...
    def update_leaderboard_sheet(self):
        ...
        self.spread.df_to_sheet(df=df, index=False, sheet=self.leaderboard_sheet)
    ...
    def update_games_sheet(self):
        ...
        df["rank"] = [
            (
                game.round_num,
                game.bye,
                -sum_value(game, value="score"),
                -sum_value(game, value="elo"),
            )
            for game in self.games
        ]
    ...
    def add_current_round_openings(self, round_num: int | None = None):
        ...
        self.spread.df_to_sheet(games_df, index=True, sheet=self.games_sheet)
